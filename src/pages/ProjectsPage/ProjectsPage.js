...
class ProjectsPage extends Component {
  ...
  render() {
    const displayProjects = ()=>Projects.map(projectObj=>{
      const newProjectKey = "project-"+projectObj.title.replace(/ /g,'').toLowerCase();
      return (
        <Project
          key={newProjectKey}
          ...
          gitHubRepoLink={projectObj.gitHubRepoLink}
